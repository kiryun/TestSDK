...
![image-20200525110735278](SDK뼈대만들기.assets/image-20200525110735278.png)
...
![image-20200525110856630](SDK뼈대만들기.assets/image-20200525110856630.png)



그리고 File > New > WorkSpace ... 를 선택해 새로운 Workspace를 만들어주고 현재 열려있는 Objective - C project를 닫아줍니다.

![image-20200525111010865](SDK뼈대만들기.assets/image-20200525111010865.png)

새로 만들어주는 Workspace의 위치는 최상위 폴더 바로 밑으로 정해줍니다.

![image-20200525111543262](SDK뼈대만들기.assets/image-20200525111543262.png)



새로 만들어준 workspace를 열고 그안에 기존의 xcodeproj 파일(_TestSDK.xcodeproj)을 드래그 앤 드롭 해줍니다.

![image-20200525111402385](SDK뼈대만들기.assets/image-20200525111402385.png)



이후 새로 만들어지는 xcodeproj파일들도 workspace에 드래그 앤 드롭 해주도록 합니다.

![image-20200525111641886](SDK뼈대만들기.assets/image-20200525111641886.png)
...
![image-20200525112710889](SDK뼈대만들기.assets/image-20200525112710889.png)



그리고 난 후에 _TestSDK > TARGETS > _TestSDK > Framework and Libraries에 TestSDK.framework를 드래그앤 드롭 해줍니다.

![image-20200525112847421](SDK뼈대만들기.assets/image-20200525112847421.png)



TestSDK의 Products 그룹을 보면 TestSDK.framework 를 누르면 다음과 같이 경로를 확인할 수 있습니다.

![image-20200525113422097](SDK뼈대만들기.assets/image-20200525113422097.png)

> **안해줘도 상관없습니다.**
>
> 또한 아래의 Target Membership에 체크를 해줍니다.
>
> ![image-20200525154148277](SDK뼈대만들기.assets/image-20200525154148277.png)
...
>
> ![image-20200525113744974](SDK뼈대만들기.assets/image-20200525113744974.png)
...
![image-20200525132828796](SDK뼈대만들기.assets/image-20200525132828796.png)

> **안해줘도 상관없습니다.**
>
> 마찬가지로 Frameworks, Product 그룹에 TestSDK.framework 의 TargetMembership에 체크를 해줍니다.
>
> ![image-20200525154252049](SDK뼈대만들기.assets/image-20200525154252049.png)
>
> ![image-20200525154459571](SDK뼈대만들기.assets/image-20200525154459571.png)
...
![image-20200525150936068](SDK뼈대만들기.assets/image-20200525150936068.png)



TestApp > TARGETS > TestAPpp > General > Frameworks, Libraries, and Embedded Content > + > _TestSDK.framework 를 추가해줍니다.

![image-20200525151113557](SDK뼈대만들기.assets/image-20200525151113557.png)
...
>
> ![image-20200525154602801](SDK뼈대만들기.assets/image-20200525154602801.png)
...
![image-20200525154952496](SDK뼈대만들기.assets/image-20200525154952496.png)
